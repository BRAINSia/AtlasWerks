...
GenerateScheduleFromImage( const ImageType* image )
{
    ...
    // keep downsampling by a factor of 2 until the image has a
    // dimension of size 32 or smaller
    while (true) {
    ...
    // put this in a ScheduleType object (Array2D), reversing order
    // (put it in order largest downsample factor to smallest)
...
EstimateAffine::_StepEstimateTranslation( unsigned level )
{
    ...
    for( unsigned int zPos = roiStart[2]; zPos <= roiStop[2]; zPos++ ) {
		...
		i0=i1=i2=i3=i4=i5=i6=i7=0; // make compiler happy
		a0=a1=a2=a3=a4=a5=a6=a7=0; // make compiler happy
                if( Array3DUtils::
