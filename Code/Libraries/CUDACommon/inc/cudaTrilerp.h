...
__device__ float getTexVal(int index){
    return tex1Dfetch(com_tex_float, index);
}

__device__ float getTexValX(int index){
    return tex1Dfetch(com_tex_float_x, index);
}

__device__ float getTexValY(int index){
    return tex1Dfetch(com_tex_float_y, index);
}

__device__ float getTexValZ(int index){
...
//////////////////////////////////////////////////////////////////////////////////////////
__device__ float getPixel3D(int x, int y, int z,
                            float* d_i,
...
__device__ void getPixel3D(float& vx, float& vy, float& vz,
                           int x, int y, int z,
...
__device__ void getPixel3D_tex(float& vx, float& vy, float& vz,
                               int x, int y, int z,
                               int sizeX, int sizeY, int sizeZ)
{
    int index = (z * sizeY + y) * sizeX + x;
...
// ad can not handle sophisicated strategy 
__device__ float simple_triLerp_kernel(float *image ,
...
__device__ float simple_triLerpTex_kernel(float* image, float x, float y, float z,
                                          uint w, uint wh)
{
    int xInt, yInt, zInt;
    float dx, dy, dz;
...
//////////////////////////////////////////////////////////////////////////////////////////
__device__ void wrapBackground(int& floorX, int& ceilX, int sizeX){
...
__device__ void wrapBackground(int& floorX,int& floorY,int& floorZ,
...
// Clamp strategy
//////////////////////////////////////////////////////////////////////////////////////////
__device__ void clampBackground(int& floorX, int& ceilX, int sizeX){
...
__device__ void clampBackground(int& floorX,int& floorY,int& floorZ,
                                int& ceilX, int& ceilY, int& ceilZ,
                                int  sizeX, int  sizeY, int  sizeZ){
...
__device__ int isInside(int floorX,int floorY,int floorZ,
                        int ceilX, int ceilY, int ceilZ,
                        int  sizeX, int  sizeY, int  sizeZ){
