...
/**
 * \page GreedyAtlas GreedyAtlas
 * Simple frontend program for computing an atlas via Greedy LDMM algorithm
 *
 * If tests have been run (`make test'), an example page has been generated
 * \htmlonly
 * <a href="../../Testing/Applications/Greedy/GreedyAtlas/index.html"><b>here.</b></a>
 * \endhtmlonly
 */
...
/** Simple parameter class to hold parameters for GreedyAtlas program */
class GreedyAtlasParamFile : public GreedyAtlasParam {
public:
  GreedyAtlasParamFile()
    : GreedyAtlasParam("ParameterFile", "top-level node", PARAM_REQUIRED)
  {
...
int main(int argc, char ** argv)
{
  ...
  if(pf.UseGPU()){
#ifdef CUDA_ENABLED
    builder = new GreedyAtlasBuilder<GreedyAtlasManagerGPU>
    ...
    builder = new GreedyAtlasBuilder<GreedyAtlasManagerCPU>
      (imageSet, pf, pf.nThreads(), nodeID, nNodes, nTotalImages);
  }
