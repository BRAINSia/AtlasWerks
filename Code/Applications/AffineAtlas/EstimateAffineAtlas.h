...
// File: EstimateAffineAtlas.h (Quasi-Newton Step Method)
//
// Mark Foskey
// Peter Lorenzen
#ifndef _ESTIMATE_AFFINEATLAS_H_
#define _ESTIMATE_AFFINEATLAS_H_
...
public:
    ...
    struct EstimateAffineAtlasLevelStruct {
    ...
    // Methods
    EstimateAffineAtlas( const ImageType* movingImage, 
                    const ImageType* fixedImage,
...
private:
    ...
    // Levels
    std::vector< EstimateAffineAtlasLevelStruct > _levels;
...
#endif // #ifndef _ESTIMATE_AFFINEATLAS_H_
