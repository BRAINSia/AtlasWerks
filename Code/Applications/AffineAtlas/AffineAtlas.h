...
#ifndef _AFFINEATLAS_H_
#define _AFFINEATLAS_H_
...
AffineAtlas(char* file1, char*file2, string type);
AffineAtlas(ImagePointer fixedImage,
	ImagePointer movingImage,string type);
AffineTransform3D<double> registrationTransform;
void _applyAffineTransform(const AffineTransform3D<double>& , ImagePointer , ImagePointer ,std::string& ,ImagePointer);
