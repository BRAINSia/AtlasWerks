...
print GetStartHTML("LDMMVelShootingWarp Tests")

# energy graph
print "<h2>LDMM Velocity Shooting Warp Convergence</h2>"
...
print "<h2>LDMM Velocity Shooting Warp Images</h2>"
print "<table>"
print "<tr>"
print "<td>LDMM Velocity Shooting Warp</td>"
warpImageData = "LDMMVelShootingWarpBullseyeTestBlur00_to_BullseyeTestBlur01DefImage.mha"
