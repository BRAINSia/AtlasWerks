...
print GetStartHTML("LDMMAdShootingWarp Tests")

# energy graph
print "<h2>LDMM Shooting Warp Convergence</h2>"
...
print "<h2>LDMM Shooting Warp Images</h2>"
print "<table>"
print "<tr>"
print "<td>LDMM Shooting Warp</td>"
warpImageData = "LDMMAdShootingWarpBullseyeTestBlur00_to_BullseyeTestBlur01DefImage.mha"
