...
parsedXML = warpDir + "GreedyWarpParsedOutput.xml"
...
print GetStartHTML("GreedyWarp Tests")

# energy graph
print "<h2>Greedy Warp Convergence</h2>"
...
print "<h2>Greedy Warp Images</h2>"
print "<table>"
print "<tr>"
print "<td>Greedy Warp</td>"
warpImageData = "GreedyBullseyeTestBlur00_to_BullseyeTestBlur01DefImage.mha"
